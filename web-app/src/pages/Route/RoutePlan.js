...
//   // Fetch route plans from backend
//   useEffect(() => {
//     const fetchRoutes = async () => {
//       try {
//         const res = await api.get('/route'); // GET /api/route
//         setRoutes(res.data);
//       } catch (err) {
...
//                         try {
//                           await api.delete(`/route/${r.id}`);
//                           setRoutes(routes.filter(route => route.id !== r.id));
//                         } catch (err) {
